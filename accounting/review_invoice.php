        ...
        <div class="row" >
            ...
            <div class="col-md-4" >
                <div class="card p-3 sticky-admin-bar" style="background-color: #335E53; color: #f8f9fa">
                    ...
                    <hr>
                    <form method="POST" action="../controller/accounting_update_invoice_status.php">
                        <input type="hidden" name="invoice_id" value="<?php echo $invoice['id']; ?>">

                        <div class="mb-3">
                            <label for="approvalStatus" class="form-label"><b>Update Status</b></label>
                            <p style="font-size: 0.6em">Choose for MT Approval (Forward it to be approved by the master) or Deny</p>
                            <select name="approval_status" id="approvalStatus" class="form-select" required>
                                <option value="" disabled selected>Select</option>
                                <option value="MT Approval" <?php echo $invoice['approval_status'] === 'MT Approval' ? 'selected' : ''; ?>>For MT Approval</option>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="payor" id="payor" class="form-select" required>
                                <option value="" disabled selected>Select</option>
