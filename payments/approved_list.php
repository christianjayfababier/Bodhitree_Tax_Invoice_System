...
$query = "SELECT * FROM invoice_list WHERE approve_true = 'Approved'";
        ...
        <table class="table table-bordered" >
            ...
            <?php while ($row = $result->fetch_assoc()): ?>
                <tr style="font-size: 0.8em; vertical-align: middle;" >
                    ...
                    <td>
                        <a href="check_approved.php?id=<?php echo $row['id']; ?>" class="btn btn-primary btn-sm" style="width: 100%">View</a>
