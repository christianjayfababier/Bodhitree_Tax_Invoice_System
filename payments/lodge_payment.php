...
if (!$invoice_id) {
    ...
    header("Location: payment_lodging.php");
    exit;
}
        ...
        <div class="row" >
            ...
            <div class="col-md-8" >
                ...
                <div class="row">
                    <div class="col">
                        <div class="mb-3">
                            <label for="reviewNotes" class="form-label"><b>Manager Note</b></label>
            ...
            <div class="col-md-4" >
                            ...
                            <div class="card p-3 sticky-admin-bar" style="background-color: #335E53; color: #f8f9fa">
                                ...
                                <hr>
                                <form method="POST" action="../controller/lodge_payment_status_payments.php">
                                    <input type="hidden" name="invoice_id" value="<?php echo $invoice['id']; ?>">

                                    <div class="mb-3">
                                        <label for="approvalStatus" class="form-label"><b>Mark as Lodged</b></label>
                                        <select name="approval_status" id="approvalStatus" class="form-select">
                                            <option value="Lodge Payment" disabled <?php echo $invoice['approval_status'] === 'Lodge Payment' ? 'selected' : ''; ?>>On Process(Current)</option>
                                            <option value="Payment Lodged" <?php echo $invoice['approval_status'] === 'Payment Lodged' ? 'selected' : ''; ?>>Payment Lodged ✅</option>
                                        </select>
                                    </div>


                                    <?php if (!empty($invoice['payment_lodger']) && $invoice['approval_status'] !== 'Lodge Payment'): ?>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            <label for="lodgedDate" class="form-label"><b>Date Reviewed</b></label>
                                            <input type="text" class="form-control" id="lodgedDate" value="<?php echo htmlspecialchars($invoice['lodged_date']); ?>" readonly>
                                        </div>
                                    <?php endif; ?>
