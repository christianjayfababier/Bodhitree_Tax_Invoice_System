...
$query = "SELECT * FROM invoice_list WHERE approval_status = 'MT Approval'";
...
<div class="content">
    <div class="container mt-4">
        <h1>Masters Approval Pending</h1>
        ...
        <table class="table table-bordered" >
            ...
            <?php while ($row = $result->fetch_assoc()): ?>
                <tr style="font-size: 0.8em; vertical-align: middle;" >
                    <td>
                        <?php if ($row['approval_status'] == 'MT Approval'): ?>
                            <span class="badge text-white" style="background-color: #335E53;">For Masters Approval</span>
                        <?php endif; ?>
                    </td>
                    ...
                    <td>
                        <a href="for_mt_approval.php?id=<?php echo $row['id']; ?>" class="btn btn-primary btn-sm" style="width: 100%">Review</a>
