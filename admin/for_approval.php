            ...
            <div class="col-md-4" >
                            ...
                            <div class="card p-3 sticky-admin-bar" style="background-color: #335E53; color: #f8f9fa">
                                ...
                                <form method="POST" action="../controller/for_approval_status.php">
                                    ...
                                    <div class="mb-3">
                                        <label for="approve_true" class="form-label"><b>Approve?</b></label><br>
                                        <select name="approve_true" id="approve_true" class="form-select" required>
                                            <option value="Approved" <?php echo $invoice['approve_true'] === 'Approved' ? 'selected' : ''; ?>>Yes</option>
                                            <option value="Denied" <?php echo $invoice['approve_true'] === 'Denied' ? 'selected' : ''; ?>>No</option>
                                        </select>
                                    </div>
