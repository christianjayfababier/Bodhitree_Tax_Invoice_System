...
<?php include 'includes/header.php'; ?>
    ...
    <div class="content">
        <div class="container mt-4">
            <h1>Dashboard</h1>
            <p>This is managers dashboard. Below are the counts for tax invoice records and pending requests.</p>
            <hr>
            <!-- Dashboard Tiles -->
            <div class="row">
                <div class="col-md-3">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                <?php
                $pending_invoices = $conn->query("SELECT * FROM invoice_list WHERE approval_status = 'Pending' AND invoice_class = 'Repair and Maintenance'");
